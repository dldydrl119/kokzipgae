...
function mailer($fname, $fmail, $to, $subject, $content, $type=0, $file="", $cc="", $bcc="")
{
	...
	if(TB_SMTP == "smtp.gmail.com"){
		$mail->SMTPSecure	=	'tls';
		$mail->Username		=	'maum3751@gmail.com';
		$mail->Password		=	'sy1939139**';
		$mail->SMTPAuth		=	true;	
		$mail->CharSet			=	'UTF-8'; 
		$mail->Encoding		=	"base64";
	}else if(TB_SMTP == "smtp.naver.com"){
		$mail->SMTPSecure	=	'tls';
		$mail->Username		=	'sbj0710w@naver.com';
		$mail->Password		=	'ueUDrV';
		$mail->SMTPAuth		=	true;	
		$mail->CharSet			=	'UTF-8'; 
		$mail->Encoding		=	"base64";	
	}
