...
if($_POST['mode'] == 'w') {
	...
	$subject = $wr_name.'님께서 신고문의에 새글을 작성하셨습니다.';
	...
	alert("정상적으로 접수 되었습니다. 빠른 시간안에 답변드리겠습니다", TB_BBS_URL."/report_list.php");
}
...
$form_action_url = TB_HTTPS_BBS_URL.'/report_write.php';
include_once(TB_THEME_PATH.'/report_write.skin.php');
