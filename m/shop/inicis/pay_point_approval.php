...
include_once(TB_MSHOP_PATH.'/settle_point_inicis.inc.php');
...
$sql = " select * from shop_point_order_data where od_id = '$oid' ";
$row = sql_fetch($sql);

$data = unserialize(base64_decode($row['dt_data']));

$order_action_url		=	TB_SHOP_URL.'/point_payment_update.php';
$page_return_url		=	TB_SHOP_URL.'/point_payment.php';
...
if($_REQUEST['P_STATUS'] != '00') {
	...
	*/
	...
	$resultMap["tid"]					=	$PAY['P_TID'];
	$resultMap["MOID"]			=	$oid;
	$resultMap["TotPrice"]		=	$PAY['P_AMT'];
	$resultMap["applNum"]		=	$PAY['P_AUTH_NO'];
