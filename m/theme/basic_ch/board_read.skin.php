...
<div class="btn_confirm">
	...
	<a href="<?php echo TB_MBBS_URL; ?>/board_write.php?<?php echo $qstr2;?>&w=r" class="btn_medium bx-white">答辩</a>
	...
	<a href="<?php echo TB_MBBS_URL; ?>/board_delete.php?<?php echo $qstr2;?>" class="btn_medium bx-white">删除</a>
	<?php } ?>
</div>
