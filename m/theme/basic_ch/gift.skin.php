...
<div id="sct_hdesc">
	<fieldset class="coupon_se">
		...
		<div class="tac">
			<button type="submit" id="btn_submit" class="btn_large wset">优惠券登记</button>
		</div>
		</form>
		...
		function form_check(f) 
		{
			...
			check_field(f.gi_num1, "请输入第一个优惠券编号。");
			check_field(f.gi_num2, "请输入第二个优惠券编号。");
			check_field(f.gi_num3, "请输入第3个优惠券编号。");
			check_field(f.gi_num4, "请输入第四种优惠券编号。");
...
<div id="scp_list">
	<ul>
		...
		if($i == 0)
			echo '<li class="empty_list">没有明细。</li>';
		?>
	</ul>
</div>
<!-- } 优惠券认证结束 -->
