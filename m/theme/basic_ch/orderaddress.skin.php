...
<div id="sod_addr" class="new_win">
		...
		<ul>
            ...
            <li>
                ...
                <div class="addr_btn">
                    ...
                    <button type="button" id="btn_sel" class="btn_lsmall sel_address">选择</button>
                </div>
            </li>
            <?php
				}
    ...
    <div class="win_btn">
		<button type="button" class="btn_medium bx-white" onclick="self.close();">关闭窗口</button>
    </div>
</div>
</form>
