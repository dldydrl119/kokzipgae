...
<div id="smb_my">
	...
	<section id="smb_my_wish">
        <h2 class="anc_tit">最近のウィシリスト<span class="fr"><a href="<?php echo TB_MSHOP_URL; ?>/wish.php" class="btn_txt">もっと見る<i class="fa fa-angle-right"></i></a></span></h2>
        <ul>
            <?php
            $sql = " select *
            ...
            if($i == 0) echo '<li class="empty_list">保管内訳がありません。</li>';
            ?>
        </ul>
    </section>
</div>
