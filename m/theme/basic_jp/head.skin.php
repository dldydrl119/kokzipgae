...
<div id="wrapper">
	...
	<?php if($banner1 = mobile_banner(1, $pt_id)) { // 上段大船 ?>
	...
	<header id="header">
		...
		<div id="hd_sch">
			...
			<div class="m_rkw_se" id="rkw_open">
				<?php echo mobile_display_tick("今週の検索語", 6); ?>
	...
	<div id="container"<?php if(!defined("_MINDEX_")) { ?> class="sub_wrap"<?php } ?>>
		<nav id="gnb">
			<ul>
				<li><a href="<?php echo TB_MSHOP_URL; ?>/listtype.php?type=2">ベストセラー</a></li>
				<li><a href="<?php echo TB_MSHOP_URL; ?>/listtype.php?type=3">新商品</a></li>
				<li><a href="<?php echo TB_MSHOP_URL; ?>/listtype.php?type=4">人気商品</a></li>
				<li><a href="<?php echo TB_MSHOP_URL; ?>/listtype.php?type=5">推薦商品</a></li>
				<li><a href="<?php echo TB_MSHOP_URL; ?>/brand.php">ブランドショップ</a></li>
				<li><a href="<?php echo TB_MSHOP_URL; ?>/plan.php">企画展</a></li>
				<li><a href="<?php echo TB_MSHOP_URL; ?>/timesale.php">タイムセール</a></li>
			</ul>
		</nav>
		<script>
		//上部スライドメニュー
