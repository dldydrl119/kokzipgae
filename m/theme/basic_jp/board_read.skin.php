...
<div class="btn_confirm">
	...
	<a href="<?php echo TB_MBBS_URL; ?>/board_write.php?<?php echo $qstr2;?>&w=r" class="btn_medium bx-white">答弁</a>
	<?php } if(($mb_no == $write['writer']) || is_admin()) { ?>
	<a href="<?php echo TB_MBBS_URL; ?>/board_write.php?<?php echo $qstr2;?>&w=u" class="btn_medium bx-white">修整</a>
	<a href="<?php echo TB_MBBS_URL; ?>/board_delete.php?<?php echo $qstr2;?>" class="btn_medium bx-white">削除</a>
	<?php } ?>
</div>
