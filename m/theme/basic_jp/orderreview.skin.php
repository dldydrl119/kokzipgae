...
<h2 class="anc_tit mart20">購入後期送る</h2>
<div class="tbl_frm01 tbl_wrap">
	...
	<tr>
		<th scope="row"><label for="wr_score">評点</label></th>
		<td>
			<select name="wr_score" id="wr_score">
				<option value="">評点選択</option>
...
<div class="btn_confirm">
	<button type="submit" class="btn_medium">確認</button>
	<button type="button" onclick="window.close();" class="btn_medium bx-white">キャンセル</button>
</div>
</form>
