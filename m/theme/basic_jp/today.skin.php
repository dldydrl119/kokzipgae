...
<div id="sod_ws">
	<p id="sod_fin_no">
		<strong>총 <?php echo number_format($total_count); ?>全体</strong>の最近本商品があります。
	</p>

	<?php 
	if(!$total_count) {
		echo "<p class=\"empty_list\">最近見た商品がありません。</p>";
	} else {
	?>
	<div class="ws_wrap">
		<table>
		...
		<tr>
			...
			<td class="wish_info">
				...
				<div class="wish_del"><a href="<?php echo TB_MSHOP_URL; ?>/today.php?w=d&gs_id=<?php echo $gs_id; ?>" class="btn_small grey">削除</a></div>
			</td>
		</tr>
		<?php } ?>
		</tbody>
