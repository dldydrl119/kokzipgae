...
<div class="m_bo_bg">
	...
	<select name="faq_type" class="faq_sch" onchange="location=this.value;">
		<option value="<?php echo TB_MBBS_URL; ?>/board_list.php?boardid=<?php echo $boardid; ?>">全体見る</option>
		<?php
	...
	<?php
	if(!$total_count) {
		echo "<p class=\"empty_list\">掲示文がありません。</p>";
	} else {
	?>
	<ul>
		<?php
	...
	<div class="btn_confirm">
		<a href="<?php echo TB_MBBS_URL; ?>/board_write.php?boardid=<?php echo $boardid;?>" class="btn_medium">文を書く</a>
	</div>
	<?php } ?>
