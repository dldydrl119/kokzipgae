...
<h2 class="pop_title">
	...
	<a href="javascript:cl_list();" class="btn_small bx-white">View Total Products</a>
</h2>
...
<div id="sit_review">
	...
	for($i=0; $row=sql_fetch_array($result); $i++)
	{
		...
		if(is_admin() || ($member['id'] == $row['writer_s'])) {
			echo "<a href=\"javascript:window.open('".TB_MSHOP_URL."/orderreview.php?gs_id=$row[gs_id]&me_id=$row[index_no]&w=u');\" class=\"marl10 tu fc_blk\">Modified</a>\n";			
			echo "<a href=\"".TB_MSHOP_URL."/orderreview_update.php?gs_id=$row[gs_id]&me_id=$row[index_no]&w=d&hash=$hash&p=1\" class=\"marl5 tu fc_blk itemqa_delete\">delete</a>\n";
		}
		echo "</span>\n";
		echo "</li>\n";
	}
...
No data available.</li>\n";
	...
	<div class="btn_confirm">
		<a href="javascript:window.open('<?php echo TB_MSHOP_URL; ?>/orderreview.php?gs_id=<?php echo $gs_id; ?>');" class="btn_medium">Write a Review</a>
