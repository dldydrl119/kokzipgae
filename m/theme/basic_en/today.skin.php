...
<div id="sod_ws">
	<p id="sod_fin_no">
		<strong>Total <?php echo number_format($total_count); ?>the number</strong>There is a recent item for
	</p>

	<?php 
	if(!$total_count) {
		echo "<p class=\"empty_list\">There are no recent products.</p>";
	} else {
	?>
	<div class="ws_wrap">
		<table>
		...
		<tr>
			...
			<td class="wish_info">
				...
				<div class="wish_del"><a href="<?php echo TB_MSHOP_URL; ?>/today.php?w=d&gs_id=<?php echo $gs_id; ?>" class="btn_small grey">delete</a></div>
			</td>
		</tr>
		<?php } ?>
		</tbody>
