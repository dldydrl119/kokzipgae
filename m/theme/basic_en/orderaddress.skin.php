...
<div id="sod_addr" class="new_win">
    <h1 id="win_title">Shipping list</h1>
		...
		<ul>
            ...
            <li>
                ...
                <div class="addr_btn">
                    ...
                    <button type="button" id="btn_sel" class="btn_lsmall sel_address">Selection</button>
                </div>
            </li>
            <?php
				}
    ...
    <div class="win_btn">
		<button type="button" class="btn_medium bx-white" onclick="self.close();">Close window</button>
    </div>
</div>
</form>
