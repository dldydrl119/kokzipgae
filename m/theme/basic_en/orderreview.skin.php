...
<h2 class="anc_tit mart20">Write a Review</h2>
...
<div class="btn_confirm">
	<button type="submit" class="btn_medium">check</button>
	<button type="button" onclick="window.close();" class="btn_medium bx-white">cancel</button>
</div>
</form>
