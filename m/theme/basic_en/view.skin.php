...
<div class="sp_wrap">
	...
	<div class="sp_sns">
		Satisfaction : <?php echo $aver_score; ?>% <span class="hline"></span>Reviews : <?php echo number_format($item_use_count); ?>case
	</div>
	...
	<div class="sp_tbox">
		...
		<ul class="mart3">
			<li class='tlst'>sales revenue</li>
	...
	<div class="sp_tbox">
		<ul>
			<li class='tlst'>Minimum purchase quantity</li>
	...
	<div class="sp_tbox">
		<ul>
			<li class='tlst'>Maximum purchase quantity</li>
	...
	<div class="<?php echo $sc_class; ?>">
		<ul>
			<li class='tlst'>shipping fee</li>
			<li class='trst'><?php echo mobile_sendcost_amt(); ?></li>
		</ul>
	</div>
	<div class="sp_tbox">
		<ul>
			<li class='tlst'>Shipping Available Area</li>
	...
	<div class="sp_tbox">
		<ul>
			<li class='tlst strong'>Order Option</li>
			<li class='trst fs11 padt2'>The options below are mandatory</li>
		</ul>
	</div>
	...
	<div class="sp_tbox">
		<ul>
			<li class='tlst strong'>Additional configuration</li>
			<li class='trst fs11 padt2'>Choose if you want to buy more</li>
		</ul>
	</div>
			...
			<li class="sit_opt_list">
				...
				<input type="hidden" class="io_stock" value="<?php echo $gs['stock_qty']; ?>">
					<ul>
						...
						<li class='trst'>
							<dl>
								<dt class='fl padr3'><button type="button" class="btn_small grey">Reduction</button></dt>
								<dt class='fl padr3'><input type="text" name="ct_qty[<?php echo $gs_id; ?>][]"
								value="<?php echo $odr_min; ?>" title="Quantity setting"></dt>
								<dt class='fl padr3'><button type="button" class="btn_small grey">Increase</button><dt>
								<dt class='fl padt4 tx_small'> (Remaining quantity : <?php echo $gs['stock_mod'] ? $gs['stock_qty'].'the number' : 'Unlimited'; ?>)</dt>
							</dl>
						</li>
					</ul>
				</div>
	...
	<div id="sit_tot_views" class="dn">
		<div class="sp_tot">
			<ul>
				<li class='tlst strong'>Total total amount</li>
				<li class='trst'><span id="sit_tot_price" class="trss-amt"></span><span class="trss-amt">won</span></li>
			</ul>
		</div>
	</div>
	<?php } ?>
	...
	<div class="sp_tab">
		<nav role="navigation">
			<ul>
				<li id='d1' class="active"> <a href="javascript:chk_tab(1);">Product information</a> </li>
				<li id='d2'> <a href="javascript:chk_tab(2);">Reviews</a> </li>
				<li id='d3'> <a href="javascript:chk_tab(3);">Q&A</a> </li>
				<li id='d4'> <a href="javascript:chk_tab(4);">
Return / Exchange</a> </li>
			</ul>
		</nav>
	</div>

	<div class="sp_msgt">The product information below may differ from the actual product such as options and gift information</div>
	<div id="v1">
		<div class="sp_vbox">
			<ul>
				<li class='tlst'>&#183;&nbsp;&nbsp;Product number</li>
				<li class='trst'><?php echo $gs['gcode']; ?></li>
			</ul>
			<ul>
				<li class='tlst padt2'>&#183;&nbsp;&nbsp;Manufacturer</li>
				<li class='trst padt2'><?php echo $gs['maker']; ?></li>
			</ul>
			<ul>
				<li class='tlst padt2'>&#183;&nbsp;&nbsp;Country of origin (a producer country)</li>
				<li class='trst padt2'><?php echo $gs['origin']; ?></li>
			</ul>
			<ul>
				<li class='tlst padt2'>&#183;&nbsp;&nbsp;A/S Possible status</li>
				<li class='trst padt2'><?php echo $gs['repair']; ?></li>
			</ul>
		</div>
		<div class="sp_vbox_mr">
			<ul>
				<li class='tlst'>Notice of Product Information in Electronic Commerce, etc.</li>
				<li class='trst'><a href="javascript:chk_show('extra');" id="extra">View <span class='im im_arr'></span></a></li>
			</ul>
		</div>
	...
	<div id="v2" style="display:none;">
		<?php echo mobile_goods_review("Post-purchase period", $item_use_count, $gs_id); ?>
	</div>
...
function fsubmit_check(f)
{
    ...
    if (document.getElementById("it_price").value < 0) {
        alert("I'd appreciate it if you could call me.");
        return false;
    }
    ...
    if(min_qty > 0 && sum_qty < min_qty) {
		alert("Total number of order options "+number_format(String(min_qty))+"
...
Please enter the quantity as a number.");
		...
		if(parseInt(val.replace(/[^0-9]/g, "")) < 1) {
			alert("
Please enter more than 1 quantity.");
			result = false;
			return;
		}
...
// 
Notification of product information in e-commerce etc
var old = '';
function chk_show(name) {
	...
	if(old!=submenu) {
		...
		submenu.display='';
		eval("extra").innerHTML = "close";
		old = submenu;

	} else {
		submenu.display='none';
		eval("extra").innerHTML = "View";
		old = '';
	}
}
