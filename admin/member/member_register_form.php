...
<form name="fregisterform" method="post" action="./member/member_register_form_update.php" onsubmit="return fregisterform_submit(this);" enctype="MULTIPART/FORM-DATA">
...
<div class="tbl_frm02">
	...
	<tbody>
	<tr>
		<th scope="row">회원 이미지</th>
		<td><input type="file" name="mem_img" itemname="회원 이미지" class="frm_input" size="20"></td>
	</tr>
	<tr>
		<th scope="row">회원명</th>
	...
	<tr>
		<th scope="row">아이디</th>
		<td>
			<input type="text" name="id" id="mb_id" required itemname="아이디" class="frm_input required" onkeyup="reg_mb_id_ajax();" size="20" minlength="3" maxlength="20">
