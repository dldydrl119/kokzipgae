...
if($member['id'] != 'admin' && !$member['auth_'.$pg_num] && strpos($admin_grade,$member["grade"]) === false) {
	alert("접근권한이 없습니다.");
}
...
if($code == "report")		$pg_title2 = ADMIN_MENU8_05;
if($code == "report_form")  $pg_title2 = ADMIN_MENU8_05;
