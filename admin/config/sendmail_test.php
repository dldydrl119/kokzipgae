...
if(isset($_POST['email'])) {
    ...
    for($i=0; $i<count($email); $i++)
        mailer($config['company_name'], "sbj0710w@naver.com", trim($email[$i]), '[메일검사] 제목', '<span style="font-size:9pt;">[메일검사] 내용<p>이 내용이 제대로 보인다면 보내는 메일 서버에는 이상이 없는것입니다.<p>'.TB_TIME_YMDHIS.'<p>이 메일 주소로는 회신되지 않습니다.</span>', 1);
