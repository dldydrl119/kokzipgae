				...
				?>
						<tr class="<?php echo $bg; ?>">
							<?php if ($k == 0) { ?>
								...
								<td rowspan="<?php echo $rowspan; ?>">
									<a href="<?php echo TB_ADMIN_URL; ?>/pop_orderform.php?od_id=<?php echo $row['od_id']; ?>" onclick="win_open(this,'pop_orderform','500','800','yes');return false;" class="fc_197"><?php echo $row['od_id']; ?></a>
									<?php
									// echo $sodr['disp_mobile']; 
									?>
								</td>
								<td rowspan="<?php echo $rowspan; ?>">
							...
							if ($member["grade"] == 7) {
							?>
								<td class="td_itname"><?php echo get_text($gs['gname']); ?></td>
							<?php } else { ?>
							...
							<td class="td_price" style="font-size:1.6rem"><?php echo $gw_status[$row2['dan']]; ?>
