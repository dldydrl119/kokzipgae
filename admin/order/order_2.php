...
<div class="tbl_frm01">
	...
	<tr>
		...
		<td>
			<input type="submit" name="act_button" value="상담준비" class="btn_medium red" onclick="document.pressed=this.value">
		</td>
	</tr>
	</tbody>
	</table>
...
<div class="information">
	...
	<div class="content">
		...
		<div class="desc01 accent">
			...
			<p>ㆍ입금완료 상태의 주문은 "상담준비" 상태로만 변경할 수 있으며, 주문의 일부 상품만 부분적으로 "상담준비" 상태로 변경 가능합니다.</p>
