...
<form name="fqalist" id="fqalist" method="post" action="./help/help_report_delete.php" onsubmit="return fqalist_submit(this);">
...
<div class="tbl_head01">
	...
	for($i=0; $row=sql_fetch_array($result); $i++) {
		$s_upd = "<a href=\"./help.php?code=report_form&w=u&index_no={$row['index_no']}$qstr&page=$page\" class=\"btn_small\">수정</a>";		
