...
<a href="./design.php?code=blogform" class="fr btn_lsmall red"><i class="ionicons ion-android-add"></i> 추가하기</a>
EOF;
?>
...
<form name="fbloglist" id="fbloglist" method="post" action="./design/bloglistupdate.php" onsubmit="return fbloglist_submit(this);">
...
<div class="tbl_head01">
	...
	for($i=0; $row=sql_fetch_array($result); $i++) {
		...
		$s_upd = "<a href='./design.php?code=blogform&w=u&co_id=$co_id$qstr&page=$page' class=\"btn_small\">수정</a>";
		$page_url = '/bbs/blog.php?co_id='.$co_id;		
