		...
		<table>
			...
			<tbody>
				<tr>
					...
					<td>
						<select name="sfl">
						<!-- <?php echo option_selected('title', $sfl, '작성자'); ?> -->
	...
	<div class="tbl_head01">
		<table>
			...
			for ($i = 0; $row = sql_fetch_array($result); $i++) {
				$gs	=	get_goods($row['gs_id'], 'simg1, gname, tc_code');
			...
			?>
				<tr class="<?php echo $bg; ?>">
					...
					<td><?php echo $num--; ?></td>
					<td class="tal"><a href="<?php echo TB_SHOP_URL; ?>/view.php?index_no=<?php echo $row['gs_id']; ?>" target="_blank"><b><?php echo get_text($gs['gname']); ?></b></a>
