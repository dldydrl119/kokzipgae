...
<div class="tbl_head02">
	...
	for($i=0; $row=sql_fetch_array($result); $i++) {
		...
		$tc	=	sql_fetch("select a.*, b.mem_img, b.cellphone from shop_teacher a, shop_member b where a.mb_code = b.index_no and a.index_no = '".$row["tc_code"]."'");
	?>
	<tr class="<?php echo $bg; ?>">
		...
		<td rowspan="2" class="tac"><?php echo $tc["name"]; ?></td>
