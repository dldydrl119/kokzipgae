...
<div class="local_desc02 local_desc">
	<p>
		<span class="fc_red">이미지 1번부터 6번까지 변하는 위치입니다.</span><br>
		<strong>이미지 1</strong> : 상품 메인 썸네일<br>
		<strong>이미지 2</strong> : 없음<br>
		<strong>이미지 3</strong> : 없음<br>
		<strong>이미지 4</strong> : 없음<br>
		<strong>이미지 5</strong> : 상품 상세 썸네일<br>
		<strong>이미지 6</strong> : 상품 결제 썸네일<br>
...
<div class="tbl_frm02">
	...
	<tr>
		<th scope="row">상세설명(모바일)</th>
		<td>
			<?php echo editor_html('m_memo', get_text(stripcslashes($gs['m_memo']), 0)); ?>
		</td>
	</tr>
	<tr>
