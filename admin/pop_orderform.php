...
<li><a href="#anc_sodr_addr">주문자 정보</a></li>
</ul>';
?>
...
<div id="sodr_pop" class="new_win">
	...
	<section id="anc_sodr_list">
		...
		<form name="frmorderform" method="post" action="./pop_orderstatusupdate.php" onsubmit="return form_submit(this);">
						...
						?>
							<tr class="<?php echo $bg; ?>">
								<td>
									...
									<input type="checkbox" checked name="chk[]" value="<?php echo $i; ?>" id="chk_<?php echo $i; ?>">
								</td>
								<td>
			...
			?>
				<div class="btn_list marb20">
					...
					<strong class="marr5">주문상태 변경 후 클릭해주세요. =></strong>
		...
		<?php if ($od['od_test']) { ?>
			<div class="od_test_caution">주의) 이 주문은 테스트용으로 실제 결제가 이루어지지 않았으므로 절대 확인하시면 안됩니다.</div>
		<?php } ?>
	...
	<section id="anc_sodr_memo">
		...
		<form name="frmorderform3" action="./pop_orderformupdate.php" method="post">
			...
			<textarea name="shop_memo" style="width: 100%;" id="shop_memo" rows="8" class="frm_textbox"><?php echo stripslashes($od['shop_memo']); ?></textarea>
	...
	<section id="anc_sodr_addr">
		...
		<form name="frmorderform2" action="./pop_orderformupdate.php" method="post">
			...
			<div class="compare_wrap">
				<section id="anc_sodr_orderer" style="width: 100%;" class="compare_left">
					<h3>주문하신 분</h3>
						...
						<table>
							...
							<tbody>
								...
								<tr>
									...
									<td><?php if ($od['memo']) echo get_text($od['memo'], 1);
										else echo "없음"; ?></td>
								</tr>
							</tbody>
						</table>
			...
			<div class="btn_confirm">
				<input type="submit" value="주문자 정보 수정" class="btn_medium">
				<a href="javascript:window.close();" class="btn_medium bx-white">닫기</a>
			</div>
		</form>
	</section>
