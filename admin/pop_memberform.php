...
<div id="memberform_pop" class="new_win">
	...
	<div class="tbl_frm01">
		...
		<tr>
			...
			<td colspan="3">
				<input type="file" name="mem_img" id="mem_img">
				<?php
				$bimg_str = "";
				$bimg = TB_DATA_PATH.'/member/'.$mb['mem_img'];
				if(is_file($bimg) && $mb['mem_img']) {
					...
					echo '<input type="checkbox" name="mem_img_del" value="'.$mb['mem_img'].'" id="mem_img_del"> <label for="mem_img_del">삭제</label>';
