...
if($page == "") { $page = 1; } // ページがなければ、最初のページ(1ページ)
...
<tr>
	<td class="tal">全体 <b class="fc_red"><?php echo $total_count; ?></b>問い合わせがあります。</td>
	<td class="tar">
		<a href="<?php echo TB_SHOP_URL; ?>/qaform.php?gs_id=<?php echo $index_no; ?>" onclick="win_open(this,'qaform','600','600','yes');return false" class="btn_lsmall grey">商品Q&A作成</a>
		<a href="<?php echo TB_BBS_URL; ?>/qna_list.php" target="_blank" class="btn_lsmall grey">顧客センターお問い合わせ</a>
	</td>
</tr>
</table>
</form>
...
<div class="tbl_head01 tbl_wrap">
	...
	<tr>
		<th scope="col">番号</th>
		<th scope="col">文意類型</th>
		<th scope="col" colspan="3">お問い合わせ/答え</th>
		<th scope="col">作成者</th>
		<th scope="col">作成日</th>
	</tr>
	</thead>
	...
	for($i=0; $row=sql_fetch_array($result); $i++) {
		...
		if($row['iq_answer']) {
			$icon_answer = '<img src="'.TB_IMG_URL.'/icon/icon_answer.jpg" alt="答弁を完了">';
		} else {
			$icon_answer = '<img src="'.TB_IMG_URL.'/icon/icon_standby.jpg" alt="未返答">';
		}
	...
	if(!$total_count)
		echo '<div class="empty_list bb">ドアの内訳がありません。</div>';
	?>
</div>
