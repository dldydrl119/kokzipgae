...
<div id="con_lf">
	...
	<div class="tbl_frm02 tbl_wrap">
		...
		<tr>
			<th scope="row">題目</th>
			<td><input type="text" name="subject" value="<?php echo $qa['subject']; ?>" required itemname="題目" class="frm_input wfull required"></td>
		</tr>
		<tr>
			<th scope="row">内容</th>
		...
		<tr>
			...
			<td class="td_label">
				...
				<p class="mart7">
					...
					<label><input type="radio" name="email_send_yes" value="1"<?php echo get_checked($qa['email_send_yes'],'1'); ?>> はい。</label>
					<label><input type="radio" name="email_send_yes" value="0"<?php echo get_checked($qa['email_send_yes'],'0'); ?>> いいえ</label>
				</p>
			</td>
		</tr>
		<tr>
			...
			<td class="td_label">
				...
				<p class="mart7">
					<span class="marr10">返答の可否をメールで受け取りますか?</span>
					<label><input type="radio" name="sms_send_yes" value="1"<?php echo get_checked($qa['sms_send_yes'],'1'); ?>> はい。</label>
					<label><input type="radio" name="sms_send_yes" value="0"<?php echo get_checked($qa['sms_send_yes'],'0'); ?>> いいえ</label>
				</p>
			</td>
		</tr>
		</tbody>
