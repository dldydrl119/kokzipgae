...
<div class="bd list1 marb10">
	<fieldset style="padding:0 10px;">
		...
		<tr height="40">
			...
			<strong><span class="fc_255">"<?php echo $ss_tx; ?>"</span> Total of Integrated Search Results <span class="fc_255"><?php echo number_format($total_count); ?></span>items were searched. <strong></td>
		</tr>
		<tr height="40">
			<td class="tal padr10 padl10">
				<span class="padr5">Search</span>
...
<?php if(!$total_count) { ?>
<div class="empty_list bb">have no data.</div>
<?php } ?>
