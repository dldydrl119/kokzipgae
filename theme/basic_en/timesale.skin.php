...
function CountDownTimer(dt, id)
{
	...
	function showRemaining() {
		...
		var str = "";
		str += 'Remaining time <span class="num">'+days + '</span> a day ';
		str += '<span class="num">'+pad(hours,2) + '</span> time ';
		str += '<span class="num">'+pad(minutes,2) + '</span> minutes ';
		str += '<span class="num">'+pad(seconds,2) + '</span> seconds';
...
<h2 class="pg_title">
	<div class="inner">
		<dl class="txt_bx">
			<dt>a time sale</dt>
			<dd>Meet a special sale for a limited time</dd>
		</dl>
	</div>
</h2>
