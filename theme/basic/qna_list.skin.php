		...
		<div class="container1">
			...
			<div class="right_box">
			  ...
			  <div class="content_box">
				...
				<div class="sub_title01"><h3>내문의 내역</h3></div><!-- Sub_title01 Area End -->
				<div id="my_inquiry">
				  <ul>
					<?php
					...
					?>
					<li>
					  <a href="qna_read.php?index_no=<?=$row['index_no']?>">
				  ...
				  <div id="pager">
					...
					?>
					<button class="prev"  onclick="location.href='qna_list.php?page=<?=$prev?>'"><img src="./../img/prev.png" alt="prev"></button>
					<div class="count"><span><?=$page?></span><p>/</p><div class="maximum"><?=$total_page?></div></div>
					<button class="next" onclick="location.href='qna_list.php?page=<?=$next?>'"><img src="./../img/next.png" alt="next"></button>
				  </div><!-- Pager Area End -->

				  <div class="btn_box">
					<a href="qna_write.php">1:1 문의하기</a>
				  </div>
				</div>
