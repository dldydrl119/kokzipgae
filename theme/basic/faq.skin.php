			  ...
			  <div class="content_box">
				...
				<div id="faq">
				  ...
				  <div id="pager">
					...
					?>
					<button class="prev"  onclick="location.href='faq.php?faqcate=<?=$faqcate?>&page=<?=$prev?>'"><img src="./../img/prev.png" alt="prev"></button>
					<div class="count"><span><?=$page?></span><p>/</p><div class="maximum"><?=$total_page?></div></div>
					<button class="next" onclick="location.href='faq.php?faqcate=<?=$faqcate?>&page=<?=$next?>'"><img src="./../img/next.png" alt="next"></button>
				  </div><!-- Pager Area End -->
