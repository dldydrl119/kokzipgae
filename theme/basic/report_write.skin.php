					...
					<form name="fqaform" id="fqaform" method="post" action="<?php echo $form_action_url; ?>" autocomplete="off">
						...
						<div class="content_box">
							...
							<div id="my_inquiry_write">
									...
									<table>
										<tbody>
											<tr>
												...
												<td>
													<select name="catename" required itemname="신고유형">
														<option value="">신고하실 유형을 선택하세요</option>
														<?php
								...
								<div class="text_box">
									<textarea name="memo" required placeholder="신고내용을 입력해주세요."></textarea>
								</div>
								<div class="btn_wrap">
									<a href="javascript:fqaform.submit(document.fqaform);" class="btn_1">신고하기</a>
