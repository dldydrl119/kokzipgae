	...
	<div class="container1" >
	  ...
	  <div class="right_box">
		...
		<div class="content_box">
		  ...
		  <div class="sub_title01"><h3>포인트</h3></div><!-- Sub_title01 Area End -->
			  <div id="my_point_list">
				<div class="my_point">사용가능 포인트 <span><?=number_format($member['point'])?></span>P</div>
				<ul>
					<?php
					for($i=0; $row=sql_fetch_array($result); $i++) {

						if($row['po_point'] >= 0){
							$set_point = "+".$row['po_point'];
						}else{
							$set_point = $row['po_point'];
						}
					?>
				  <li>
					<dl class="top">
					  <dt class="txt"><?=$row['po_content']?></dt>
					  <dd class="use_point"><span><?=$set_point?></span>P</dd>
					</dl>
					<dl class="bottom">
					  <dt class="date"><?=substr($row['po_datetime'],0,10)?></dt>
					  <dd class="rest_point"><span><?=$row['po_mb_point']?></span>P</dd>
					</dl>
				  </li>
					<?php
					}
