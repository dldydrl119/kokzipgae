...
<div class="vi_info">
	...
	<div class="vi_txt_bx">
		...
		<div class="vi_txt_li">
			...
			<dl>
				<dt>客户商品评价</dt>
				<dd>评估 : <?php echo $item_use_count; ?>案件, 评分 : <img src="<?php echo TB_IMG_URL; ?>/sub/view_score_<?php echo $star_score; ?>.gif"></dd>
			</dl>
			<dl>
				<dt>商品URL 社交共享</dt>
			...
			<ul id="option_set_added">
				<li class="sit_opt_list vi_txt_li">
					<dl>
						...
						<dd class="li_ea">
							<span>
								<button type="button" class="defbtn_minus">减少</button><input type="text" name="ct_qty[<?php echo $index_no; ?>][]" value="<?php echo $odr_min; ?>" class="inp_opt" title="数量设定" size="2"><button type="button" class="defbtn_plus">增加</button>
							</span>
							<span class="marl7">(库存数量 : <?php echo $gs['stock_mod'] ? display_qty($gs['stock_qty']) : /'无限制'; ?>)</span>
						</dd>
					</dl>
				</li>
			</ul>
...
<section class="mart50">
	...
	<div class="vi_tab">
		<ul>
			<li onclick="javascript:pg_anchor('tab1')" class="on">产品信息</li>
			<li onclick="javascript:pg_anchor('tab2')">商品评价</li>
			<li onclick="javascript:pg_anchor('tab3')">商品咨询</li>
			<li onclick="javascript:pg_anchor('tab4')">配送/交换/退货介绍</li>
		</ul>
	</div>
	...
	<div class="tbl_frm02 tbl_wrap mart15">
		...
		<tbody>
		<tr>
			<th scope="row">商品代码</th>
			<td><?php echo $gs['gcode']; ?></td>
			<th scope="row">附加税, 면세여부</th>
			<td><?php echo ($gs['notax'])?"应税商品":"免税商品"; ?></td>
		</tr>
		<tr>
			<th scope="row">售后服务咨询</th>
			<td><?php echo ($gs['repair'])?$gs['repair']:"制造商售后服务咨询"; ?></td>
			<th scope="row">凭单签发</th>
			<td><?php echo ($gs['notax'])?"可以开具税务发票，现金收据":"没有税务发票，没有现金收据"; ?></td>
		</tr>
		</tbody>
		</table>
	</div>
...
<section class="mart50">
	...
	<div class="vi_tab">
		<ul>
			<li onclick="javascript:pg_anchor('tab1')">产品信息</li>
			<li onclick="javascript:pg_anchor('tab2')" class="on">商品评价</li>
			<li onclick="javascript:pg_anchor('tab3')">商品咨询</li>
			<li onclick="javascript:pg_anchor('tab4')">配送/交换/退货介绍</li>
		</ul>
	</div>
...
<section class="mart50">
	...
	<div class="vi_tab">
		<ul>
			<li onclick="javascript:pg_anchor('tab1')">产品信息</li>
			<li onclick="javascript:pg_anchor('tab2')">商品评价</li>
			<li onclick="javascript:pg_anchor('tab3')" class="on">商品咨询</li>
			<li onclick="javascript:pg_anchor('tab4')">配送/交换/退货介绍</li>
		</ul>
	</div>
...
<section class="mart50">
	...
	<div class="vi_tab">
		<ul>
			<li onclick="javascript:pg_anchor('tab1')">产品信息</li>
			<li onclick="javascript:pg_anchor('tab2')">商品评</li>
			<li onclick="javascript:pg_anchor('tab3')">商品咨询</li>
			<li onclick="javascript:pg_anchor('tab4')" class="on">配送/交换/退货指南</li>
		</ul>
	</div>
	<div class="mart15">
