...
echo $cgy['img_head']; // 各分类上端形象

echo tree_category($ca_id); // 下游分类
?>

<div class="tab_sort">
	<span class="total">全部商品 <b class="fc_90" id="total"><?php echo number_format($total_count); ?></b>个</span>
	<ul>
...
<?php if(!$total_count) { ?>
<div class="empty_list bb">没有数据。</div>
<?php } ?>
